...
const DevicesList: React.FC<Props> = ({ devicesList, deviceCtx }) => {
  return (
        ...
        return (
          <View key={id} style={styles.deviceContainer}>
            <>
              ...
              <View style={[styles.iconContainer, styles.deviceIconContainer]}>
                <Pressable
                  style={({ pressed }) => [
                  ...
                  onPress={async () => {
                    await connectDevice(devicesList[id], deviceCtx);
                  }}
                >
                  <Icon
                    size={20}
